...
// CONCATENATED MODULE: ./stores/base.ts
...
let user_UserStore = (_class = (_temp = class UserStore extends Base {
  constructor(...args) {
    super(...args);
...
}, _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "name", [external_mobx_["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "age", [external_mobx_["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _applyDecoratedDescriptor(_class.prototype, "setName", [external_mobx_["action"]], get_own_property_descriptor_default()(_class.prototype, "setName"), _class.prototype)), _class);

// CONCATENATED MODULE: ./stores/config.ts

const config = {
  userStore: user_UserStore
};
/* harmony default export */ var stores_config = (config);
// CONCATENATED MODULE: ./stores/index.ts


const stores_isServer = true; // 见代码注释1

Object(external_mobx_react_["useStaticRendering"])(stores_isServer);
class stores_Store {
  // 见代码注释2
  constructor(initialState = {}) {
    for (const k in stores_config) {
      if (stores_config.hasOwnProperty(k)) {
        this[k] = new stores_config[k](initialState[k]);
      }
    }
  }
...
function initializeStore(initialState = {}) {
  if (stores_isServer) {
    return new stores_Store(initialState);
  }

  if (store === null) {
    store = new stores_Store(initialState);
  }
...
class _app_MyMobxApp extends app_default.a {
  // Fetching serialized(JSON) store state
  static async getInitialProps(appContext) {
    const ctx = appContext.ctx; // 见代码注释1
  ...
  render() {
    ...
    return (// 见代码注释3
      __jsx(external_mobx_react_["Provider"], this.mobxStore, __jsx(Component, pageProps))
    );
  }

}

/* harmony default export */ var _app = __webpack_exports__["default"] = (_app_MyMobxApp);
